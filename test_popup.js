        ...
        // flowsTableBody.innerHTML = ""; // Clear existing rows
         ...
         // const flowTable = new DataTable('#FlowsTable')
          ...
          response.flows.forEach(flow => {
            ...
            const sanitizedFlow = Object.fromEntries(
                Object.entries(flow).map(([key, value]) => [key, value || "N/A"])
            );
        
            allFlowData.push([
                sanitizedFlow.id,
                sanitizedFlow.org_id,
                sanitizedFlow.group_id,
                sanitizedFlow.user_id,
                sanitizedFlow.name,
                sanitizedFlow.uuid,
                sanitizedFlow.description,
                sanitizedFlow.client_token,
                // sanitizedFlow.display,
                sanitizedFlow.execution_count,
                sanitizedFlow.last_run,
                sanitizedFlow.active,
                sanitizedFlow.alias,
                sanitizedFlow.security_level,
                sanitizedFlow.created,
                sanitizedFlow.updated,
                sanitizedFlow.published,
                sanitizedFlow.scheduled,
                sanitizedFlow.locked,
                sanitizedFlow.last_run_success,
                sanitizedFlow.last_run_fail,
                sanitizedFlow.blob_hash,
                sanitizedFlow.log,
                sanitizedFlow.type,
                sanitizedFlow.channel_key,
                sanitizedFlow.channel_version,
                sanitizedFlow.channel_method,
                sanitizedFlow.edited,
                sanitizedFlow.rust,
                sanitizedFlow.template_name,
                // sanitizedFlow.oAuth2Apps,
                // sanitizedFlow.privileges,
                sanitizedFlow.role_type,
                api_endpoint_url
            ]);
        });
          ...
          //   client_token: flow.client_token,
          ...
          //   locked: flow.locked,
          //   last_run_success: flow.last_run_success,
          //   last_run_fail: flow.last_run_fail,
          //   blob_hash: flow.blob_hash,
          //   log: flow.log,
          //   type: flow.type,
          //   channel_key: flow.channel_key,
          //   channel_version: flow.channel_version,
          //   channel_method: flow.channel_method,
          //   edited: flow.edited,
          //   rust: flow.rust,
          //   template_name: flow.template_name,
          //   oAuth2Apps: flow.oAuth2Apps,
          //   privileges: flow.privileges,
          //   role_type: flow.role_type,
